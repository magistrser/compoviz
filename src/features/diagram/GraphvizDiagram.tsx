 ...
 */
export const GraphvizDiagram = memo(
    ({
        dot,
        onNodeClick,
        onAdd,
        ...
        dot: string;
        onNodeClick?: (selection: ResourceSelection) => void;
            ...
            const render = async () => {
                ...
                try {
                    ...
                    if (svgRef.current) {
                        ...
                        svgRef.current.querySelectorAll<SVGGElement>(".node").forEach((node) => {
                            node.style.cursor = "pointer";
                            node.addEventListener("click", () => {
                                const title = node.querySelector("title")?.textContent;
                                if (
                                    title &&
                                    !title.startsWith("cluster_") &&

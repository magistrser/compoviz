 ...
 */
export const VolumeEditor = ({
    name,
    volume,
    onUpdate,
}: {
    name: string;
    volume: ComposeResource;
    onUpdate: (volume: ComposeResource) => void;
}) => {
    const update = (field: string, value: unknown) => onUpdate({ ...volume, [field]: value });
